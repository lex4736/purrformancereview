...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<article> <section> You scored <span class="score">'+ userScore +'</span> out of <span class="score">'+ questions.length +'</span> <h3> Boss Kitty is not impressed<h3> </section><section><img src="assets/bosskittyfired.jpg"> </section></article>';
        scoreText.innerHTML = scoreTag;
    }
}